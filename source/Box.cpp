...
void Box::init(ID3D10Device* device, float scale, D3DXCOLOR c)
{
    ...
    Vertex vertices[] =
    {
		{D3DXVECTOR3(-1.0f, -1.0f, -1.0f), D3DXCOLOR(c.r*0.5,c.g*0.25,c.b,1)},
		{D3DXVECTOR3(-1.0f, +1.0f, -1.0f), D3DXCOLOR(c.r*0.25,c.g*0.5,c.b,1)},
		{D3DXVECTOR3(+1.0f, +1.0f, -1.0f), D3DXCOLOR(c.r*0.1,c.g*0.2,c.b*0.4,1)},
		{D3DXVECTOR3(+1.0f, -1.0f, -1.0f), D3DXCOLOR(c.r*0.5,c.g*0.25,c.b,1)},
		{D3DXVECTOR3(-1.0f, -1.0f, +1.0f), D3DXCOLOR(c.g,c.b,c.b,1)},
		{D3DXVECTOR3(-1.0f, +1.0f, +1.0f), D3DXCOLOR(c.r*0.1,c.g*0.05,c.b,1)},
		{D3DXVECTOR3(+1.0f, +1.0f, +1.0f), D3DXCOLOR(c.r*0.5,c.g*0.6,c.b*0.3,1)},
		{D3DXVECTOR3(+1.0f, -1.0f, +1.0f), D3DXCOLOR(c.r*0.53,c.g*0.1,c.b*0.3,1)},
    };
